...
class MondidocheckoutConfirmationModuleFrontController extends ModuleFrontController
{
     ...
     * @see OrderConfirmationControllerCore::init()
     */
     ...
     * @see OrderConfirmationControllerCore::initContent()
     */
